...
const HeroText: React.FC = () => {
    ...
    const handleGetStarted = () => {
        navigate(isAuthenticated ? "/DataSet" : "/SignUp");
    };
    ...
    return (
        <div className="relative z-10 max-w-5xl xl:max-w-6xl 2xl:max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8 mt-4 sm:mt-6 md:mt-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-10">
                <Button onClick={handleGetStarted} className="group relative overflow-hidden rounded-2xl px-6 py-2 text-white border border-white/25 bg-transparent transition-all duration-500 hover:text-cyan-200 hover:border-cyan-300 hover:shadow-[0_0_12px_1px_rgba(34,211,238,0.55)] cursor-pointer">
