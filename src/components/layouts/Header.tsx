      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="flex justify-between items-start">
          ...
          <div className="flex-1 flex justify-center ml-5">
            <ExpandableTabs tabs={tabs} defaultTab="home" />
          </div>
              ...
              >
                ...
                <DropdownMenuItem
                  className={`cursor-pointer whitespace-nowrap ${
                    theme === "dark"
                      ? "focus:bg-gray-900 focus:text-white text-white"
                ...
                <DropdownMenuItem
                  className={`cursor-pointer whitespace-nowrap ${
                    theme === "dark"
                      ? "focus:bg-gray-900 text-red-400 focus:text-red-400"
                      : "focus:bg-gray-100 text-red-600 focus:text-red-600"
                  }`}
                >
