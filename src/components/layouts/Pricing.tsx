...
const Pricing = () => {
  ...
  return (
    ...
    plan.highlighted
      ? 'border-neutral-700 bg-gradient-to-br from-black to-transparent text-white'
      : 'border-neutral-800 bg-gradient-to-br from-neutral-950 to-transparent text-white'
  }`}
            >
              {plan.highlighted && (
                <>
